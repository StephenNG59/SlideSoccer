...
int main()
{
	...
	//GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "SmashSoccer - v2.0", NULL, NULL);
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "SmashSoccer - v2.0", pMonitor, NULL);
	if (window == NULL)
	{
