...
class ParticleGenerator
{
	...
	public:
		...
		void Update(float dt, Object3D &object, unsigned int newParticles, glm::vec3 offset = glm::vec3(0));
	...
	private:
		...
		// Respawns particle
		void respawnParticle(Particle &particle, Object3D &object, glm::vec3 offset = glm::vec3(0));
