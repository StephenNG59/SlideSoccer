...
Skybox::Skybox(std::vector<std::string> facesPath, std::vector<std::string> shadersPath)
{
	this->init(facesPath, shadersPath);
}
...
void Skybox::init(std::vector<std::string> facesPath, std::vector<std::string> shadersPath)
{
